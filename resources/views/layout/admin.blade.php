...
<!-- Tambahkan di layout utama sebelum </head> -->
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('produk.index') }}">Kategori</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('pembelian.index') }}" data-target="#collapseFour"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('pelanggan.index') }}" data-target="#collapseFive"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('barang.laporan') }}" data-target="#collapseFive"
                    aria-expanded="true" aria-controls="collapseFive">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>2025 &copy; Muhamad Fadly Sidik</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
